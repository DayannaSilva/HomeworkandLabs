...
public class Perfil extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cbSelection.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "DIGITADOR", "VENDEDOR", " " }));
        cbSelection.setToolTipText("SELECCIONAR");
    ...
    private void cbSelectionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbSelectionActionPerformed
        if(cbSelection.getSelectedItem()=="DIGITADOR"){
            Registry registry = new Registry();
            registry.setVisible(true);
        }
        if(cbSelection.getSelectedItem()=="VENDEDOR"){
